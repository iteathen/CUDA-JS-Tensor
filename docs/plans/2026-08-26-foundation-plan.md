...
| `TENSOR-FUSION-017` | Optional exact generated elementwise-chain fusion ([closed issue #14](https://github.com/iteathen/CUDA-JS-Tensor/issues/14)); SPEC-0007 | `TENSOR-SIMT-012`, public CUDA-JS alpha.15 | Integrated through protected PR #16 at `main@821b1cbe`; deterministic exact regions, operation-by-operation typed locals, retained final material, deleted internal materials, immutable identity, complete unfused default and public-package native equivalence/cleanup evidence pass. |
...
| `TENSOR-DEVICE-ITEM-014` | Item-parallel device-callable Tensor program ([closed issue #19](https://github.com/iteathen/CUDA-JS-Tensor/issues/19)); SPEC-0009 | `CJS-DEVICE-LIB-002`, `CJS-DEVICE-NUMERIC-005`, `TENSOR-PROGRAM-011` | Alpha.6 integrated through protected PR #20 at `main@9ecc1d78`: one caller participant per statically independent item, finite typed ABI/workspace, public leaf-library import, complete host-planned deletion and exact native multi-item output/cleanup evidence. Cooperative intra-item acceleration remains separate. |
