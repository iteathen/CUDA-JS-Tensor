...
| `TENSOR-FUSION-017` | Optional exact generated elementwise-chain fusion ([issue #14](https://github.com/iteathen/CUDA-JS-Tensor/issues/14)); SPEC-0007 | `TENSOR-SIMT-012`, public CUDA-JS alpha.15 | Implemented alpha.5 candidate: deterministic exact regions, operation-by-operation typed locals, retained final material, deleted internal materials, immutable identity, complete unfused default and public-package native equivalence/cleanup evidence. |
