...
- [`SPEC-0009-gather-concat-item-addendum.md`](SPEC-0009-gather-concat-item-addendum.md) — accepted additive item semantics for non-axis-0 static gather from item-varying sources and ordered concat of item-varying inputs, preserving the base callable ABI/workspace owner and using an explicit compatibility child.
- [`SPEC-0010-erf-static-gather-and-concat.md`](SPEC-0010-erf-static-gather-and-concat.md) — accepted consumer-backed mathematical and ordinary-SIMT authority for `f32`/`f64` `erf`, bounded static indexed gather and finite ordered concat; device-callable gather/concat semantics are separately owned by the SPEC-0009 addendum.
- [`SPEC-0011-unary-tanh.md`](SPEC-0011-unary-tanh.md) — accepted consumer-backed `f32`/`f64` `unary:tanh` TensorProgram child using public CUDA-JS `gpu.math.tanh`, with canonical composition after SPEC-0010 and no new item-axis/ABI/workspace semantics.
