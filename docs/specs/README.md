...
- [`SPEC-0009-gather-concat-item-addendum.md`](SPEC-0009-gather-concat-item-addendum.md) — **proposal only** additive device-callable item semantics for non-axis-0 static gather and ordered concat; no implementation authority until independently accepted.
- [`SPEC-0010-erf-static-gather-and-concat.md`](SPEC-0010-erf-static-gather-and-concat.md) — **candidate only** consumer-backed semantics for `f32`/`f64` `erf`, bounded static indexed gather and finite ordered concat; no implementation authority until independently accepted.

Accepted status authorizes only the bounded contracts written in accepted specifications. Candidate and proposal specifications remain review material and do not authorize production implementation. CUDA-JS-Tensor semantic, lifecycle, native, mechanism-dependency and performance evidence remains independently gated per component.
