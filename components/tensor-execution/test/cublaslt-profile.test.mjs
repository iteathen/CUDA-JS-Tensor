...
function fakePublicRuntime({
  ...
  const runtime = {
    observation,
    async describe() { return { package: { name: 'cuda-js', version: '0.1.0-alpha.20', publicApiSchema: 1 }, state: 'open', profile: 'tensor-cublaslt-test', device: { architecture: { class: 'compute_75' } } }; },
