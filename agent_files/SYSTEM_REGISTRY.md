...
The exact current compatibility pair is `cuda-js-tensor@0.1.0-alpha.5` with `cuda-js@0.1.0-alpha.15` from protected-main revision `af29b95e0707b36b88ee4e234c25a9e7f7ed3a1d`. Portable/package evidence does not promote CUDA-JS-Tensor native or performance support.
