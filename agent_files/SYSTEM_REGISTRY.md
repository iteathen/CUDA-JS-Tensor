...
| `tensor.backend.device-callable` | Item-axis independence, typed device-function ABI, item-major outputs, dtype-partitioned per-item workspace and copied leaf-library identity | SPEC-0009/TENSOR-DEVICE-ITEM-014 ([issue #19](https://github.com/iteathen/CUDA-JS-Tensor/issues/19)); alpha.6 candidate passes portable/package and exact Windows native import/call/output/cleanup evidence |
