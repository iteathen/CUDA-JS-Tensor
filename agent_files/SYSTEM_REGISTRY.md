...
The exact current compatibility pair is `cuda-js-tensor@0.1.0-alpha.1` with `cuda-js@0.1.0-alpha.12` from protected-main revision `2da65ff2e4287450171c477031dd380a21fa095f`. Portable/package evidence does not promote CUDA-JS-Tensor native or performance support.
